...
import com.example.parstagram_fbu.LoginActivity;
import com.example.parstagram_fbu.Post;
import com.example.parstagram_fbu.R;
import com.example.parstagram_fbu.databinding.FragmentComposeBinding;
...
//        return inflater.inflate(R.layout.fragment_compose, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        fragmentComposeBinding.btnLogout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ParseUser.logOut();
                ParseUser currentUser = ParseUser.getCurrentUser();
